                            ...
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="add_bot">创建</button>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr v-for="bot in bots" :key="bot.id">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-secondary" style="margin-right: 10px"  data-bs-toggle="modal" :data-bs-target="'#update-bot-btn' + bot.id">修改Bot</button>
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="update_bot(bot)">更新</button>
                                                        <button type="button" class="btn btn-secondary">取消</button>
                                                    </div>
                                                </div>
                                            </div>
        ...
        const update_bot = (bot) => {
            ...
            $.ajax({
                ...
                success(resp){
                    console.log(resp);
                    if(resp.error_message === "success"){
                        Modal.getInstance("#update-bot-btn" + bot.id);
                        refresh_bots();
                    }else{
                        console.log(resp);
                    }
